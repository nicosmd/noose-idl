...
def get_template(template_name):
    if template_name == "idl__rosidl_typesupport_fastrtps_cpp.hpp.em":
    ...
    if template_name == "msg__rosidl_typesupport_fastrtps_cpp.hpp.em":
    ...
    if template_name == "srv__rosidl_typesupport_fastrtps_cpp.hpp.em":
